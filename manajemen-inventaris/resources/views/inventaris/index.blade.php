    ...
    <div class="container mt-5">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Persediaan Stok</h5>
            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            @foreach ($persediaan as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('persediaan.edit', ['id' => $item->id]) }}"
                                            class="btn btn-warning btn-sm text-decoration-none text-black">
                                            Edit
                                        </a>

                                        <a href="{{ route('persediaan.destroy', ['id' => $item->id]) }}"
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a href="/TambahPersediaan" class="btn btn-primary btn-sm fw-semibold">
                            Tambah Persediaan
                        </a>
                    </div>
                </div>
